...
execute if score .spdflt ir matches 0 run tellraw @a [{"text":"[Scenic Rail] ","color":"gold"},{"text":"Ride speed: ","color":"gray"},{"score":{"name":".speed","objective":"ir"},"color":"white"},{"text":" blocks/s","color":"gray"}]
execute if score .spdflt ir matches 1 run tellraw @a [{"text":"[Scenic Rail] ","color":"gold"},{"text":"Ride speed: ","color":"gray"},{"score":{"name":".speed","objective":"ir"},"color":"white"},{"text":" blocks/s (default)","color":"gray"}]
