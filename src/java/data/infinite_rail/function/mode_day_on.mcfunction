...
time set noon
tellraw @a [{"text":"[Infinite Rail] ","color":"gold"},{"text":"Time: day only - frozen at noon. ","color":"gray"},{"text":"/function infinite_rail:mode_night_off","color":"aqua"},{"text":" restores the normal cycle.","color":"gray"}]
