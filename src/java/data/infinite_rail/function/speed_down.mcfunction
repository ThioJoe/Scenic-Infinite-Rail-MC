...
execute if score .DEBUGMODE ir matches 1 run tellraw @a [{"text":"[SR Debug] ","color":"dark_aqua"},{"text":"slowing down over land, speed ","color":"yellow"},{"score":{"name":".speed","objective":"ir"},"color":"white"}]
