...
tellraw @a [{"text":"[Scenic Rail] ","color":"gold"},{"text":"Modes - rain: ","color":"gray"},{"score":{"name":".RAINMODE","objective":"ir"},"color":"white"},{"text":" | sky: ","color":"gray"},{"score":{"name":".SKYMODE","objective":"ir"},"color":"white"},{"text":" | cart hidden: ","color":"gray"},{"score":{"name":".HIDECART","objective":"ir"},"color":"white"},{"text":" | sound: ","color":"gray"},{"score":{"name":".SOUNDMODE","objective":"ir"},"color":"white"},{"text":" | mobs aggro: ","color":"gray"},{"score":{"name":".AGGROMODE","objective":"ir"},"color":"white"},{"text":" | invisible track: ","color":"gray"},{"score":{"name":".HIDETRACK","objective":"ir"},"color":"white"}]
