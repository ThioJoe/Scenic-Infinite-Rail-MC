...
# onto the landscape wherever the ride happens to be. Restores .MAXSPEED and
# hands the speed back to the ocean system with fresh counters (it was
# skipped entirely while sky mode was on).
