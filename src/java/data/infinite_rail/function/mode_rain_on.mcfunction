...
weather rain
tellraw @a [{"text":"[Infinite Rail] ","color":"gold"},{"text":"Rain mode ON - permanent rain. ","color":"gray"},{"text":"/function infinite_rail:mode_rain_off","color":"aqua"},{"text":" restores normal weather.","color":"gray"}]
