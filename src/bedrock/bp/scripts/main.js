...
const CONFIG_DEFAULTS = {
  HOVER: 2, TUNNELCLEAR: 6, CAMHEIGHT: 0, CAMBLEND: 10, CAMLIFT: 30,
  ...
  PACE_CART_BEHIND: 224, TERRAIN_GENAHEAD: 192, BUILD_FACTOR: 2, DEBUGMODE: 0,
...
function placeColumn(x, y, dir, veg) {
  ...
  // Invisible track (mode_hidetrack_* / .HIDETRACK): skip the visible rail +
  // support -- on Bedrock that is the whole feature: nothing rides the
