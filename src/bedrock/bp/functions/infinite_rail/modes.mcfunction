...
# Rain/sky/sound/mobs-aggro/invisible-track are 1 = on, 0 = off. The second line spells out the
...
tellraw @a {"rawtext":[{"text":"§6[Scenic Rail]§r §7Modes - rain: §f"},{"score":{"name":".RAINMODE","objective":"ir"}},{"text":"§7 | sky: §f"},{"score":{"name":".SKYMODE","objective":"ir"}},{"text":"§7 | cart hidden: §f"},{"score":{"name":".HIDECART","objective":"ir"}},{"text":"§7 | sound: §f"},{"score":{"name":".SOUNDMODE","objective":"ir"}},{"text":"§7 | mobs aggro: §f"},{"score":{"name":".AGGROMODE","objective":"ir"}},{"text":"§7 | invisible track: §f"},{"score":{"name":".HIDETRACK","objective":"ir"}}]}
